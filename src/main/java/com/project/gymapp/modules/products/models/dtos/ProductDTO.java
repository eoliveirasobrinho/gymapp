...
public record ProductDTO( String brand, String manufacturingDate, String name, BigDecimal price, Integer quantity, ProductDetails productDetails, ProductType productType, String valiDate) {
