...
public record UserDTO(String name, String lastName, DocumentType documentType, String document, String email, Boolean isActive, String username, String password, Role role) {
